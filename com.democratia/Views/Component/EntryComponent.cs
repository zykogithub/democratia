...
public partial class EntryComponent : ContentView
{
    ...
    {
        if (bindable is EntryComponent component && component.Content is VerticalStackLayout layout)
        {
            if (layout.Children[2] is Entry entry )
            {
                this._valeurDonne = (string)newValue;
            }
        }
    }
}
